namespace POS.Utilities.Static
{
    public class ReplyMessage
    {
        ...
        public const string MESSAGE_EXITS = "El registro ya existe.";
        ...
        public const string MESSAGE_TOKEN_ERROR = "El usuario y/o contraseña son incorrecta, comprueba tus datos";
        public const string MESSAGE_VALIDATE = "Errores de validación.";
        public const string MESSAGE_FAILED = "Operación fallida.";
        public const string MESSAGE_EXCEPTION = "Hubo un error inesperado, por favor comunicarse con el Administrador. (admin@gmail.com)";
        public const string MESSAGE_GOOGLE_ERROR = "Su cuenta no se encuentra registrada en el sistema";
        public const string MESSAGE_AUTH_TYPE_GOOGLE= "Por favor ingresa con la opcion de Google";
